...
contract CompliantLPHookTest is Test {
    ...
    function setUp() public {
        ...
        vm.prank(minter);
        uint256 tokenId1 = convexoLPs.safeMint(userWithNFT, "COMPANY123", "ipfs://test1");

        // Mint NFT to userWithInactiveNFT and then deactivate it
        vm.prank(minter);
        uint256 tokenId2 = convexoLPs.safeMint(userWithInactiveNFT, "COMPANY456", "ipfs://test2");
    ...
    function test_BeforeSwap_WithNFT_Succeeds() public {
        ...
        (bytes4 selector, BeforeSwapDelta delta, uint24 fee) = hook.beforeSwap(userWithNFT, testPool, params, "");
    ...
    function test_BeforeAddLiquidity_WithNFT_Succeeds() public {
        ...
        vm.prank(userWithNFT);
        bytes4 selector = hook.beforeAddLiquidity(userWithNFT, testPool, params, "");
    ...
    function test_BeforeAddLiquidity_WithoutNFT_Reverts() public {
        ...
        vm.prank(userWithoutNFT);
        vm.expectRevert(CompliantLPHook.MustHoldConvexoLPsNFT.selector);
        hook.beforeAddLiquidity(userWithoutNFT, testPool, params, "");
    }
    ...
    function test_BeforeRemoveLiquidity_WithNFT_Succeeds() public {
        ...
        vm.prank(userWithNFT);
        bytes4 selector = hook.beforeRemoveLiquidity(userWithNFT, testPool, params, "");
    ...
    function test_BeforeRemoveLiquidity_WithoutNFT_Reverts() public {
        ...
        vm.prank(userWithoutNFT);
        vm.expectRevert(CompliantLPHook.MustHoldConvexoLPsNFT.selector);
        hook.beforeRemoveLiquidity(userWithoutNFT, testPool, params, "");
    }
    ...
    function test_UserGainsNFT_GainsAccess() public {
        ...
        vm.prank(minter);
        convexoLPs.safeMint(userWithoutNFT, "COMPANY789", "ipfs://test3");
    ...
    function test_MultipleNFTs_StillWorks() public {
        ...
        vm.prank(minter);
        convexoLPs.safeMint(userWithNFT, "COMPANY999", "ipfs://test4");
