...
contract ConvexoVaultsTest is Test {
    Convexo_Vaults public nft;
    ...
    string public constant TOKEN_URI = "ipfs://bafkreignxas6gqi7it5ng6muoykujxlgxxc4g7rr6sqvwgdfwveqf2zw3e";

    function setUp() public {
        nft = new Convexo_Vaults(admin, minter);
    }
    ...
    function test_Soulbound_TransferFromReverts() public {
        ...
        vm.prank(user1);
        vm.expectRevert(Convexo_Vaults.SoulboundToken.selector);
